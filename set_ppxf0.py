...
if (__name__ == '__main__'):
    ...
    # run_name = "part01"
    # fcsvname = csv_dir+"test_"+suffix+".csv"
    ...
    for k in range(len(keywd)):
        spec_data = d_sci[:, yInd, xInd]
        vari_data = d_var[:, yInd, xInd]
        ...
        for nn in tqdm(range(1+niters)):
            ...
            res = run_ppxf1(spec_data2, wav_obs, pathname1, pathname2,
                            ...
                            wlim_blue_sp=4850., wlim_red_sp=7000.,
                            fig_dir=fig_dir, fig_suffix=fig_suffix, clip_sigma=4.0,
                            start0=start0,
                            regul=5., lnoi=10.,
                            adeg=12, mdeg=mdegs,
                            ...
                            fix_Av=False, Av0=None,
                            apply_phot=photoapp, bands=bands, phot_galaxy=phot_galaxy, phot_noise=phot_noise,
                            lam_phot=lam_phot) 
